 ...
 */
public class F_AreaChart区域图 extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        AreaChart<String, Number> areaChart = getView();
    ...
    public AreaChart<String, Number> getView() {
        ...
        AreaChart<String, Number> areaChart = new AreaChart<>(x, y);
        areaChart.getData().add(xy1);
        areaChart.getData().add(xy2);
        areaChart.getData().add(xy3);
        areaChart.setTitle("面积图");
