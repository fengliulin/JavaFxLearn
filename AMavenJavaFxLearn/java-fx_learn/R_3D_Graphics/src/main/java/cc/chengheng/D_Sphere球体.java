...
public class D_Sphere球体 extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        for (int i = 0; i < 5; i++) {
            // divisions: 面
            Sphere sphere = new Sphere(50, 10);
            list.add(sphere);
        }

        Sphere shape1 = (Sphere) hBox.getChildren().get(0);
        shape1.setTranslateX(-50);
        shape1.setRotationAxis(new Point3D(1, 0, 0));
        shape1.setRotate(30);

        Sphere shape2 = (Sphere) hBox.getChildren().get(1);
        ...
        Sphere shape3 = (Sphere) hBox.getChildren().get(2);
